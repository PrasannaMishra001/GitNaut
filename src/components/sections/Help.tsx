...
export const Help: React.FC = () => {
  const commands = [
    ...
    { cmd: 'gitnaut [cmd]', desc: 'GitHub analytics and repo intelligence', icon: <Terminal size={16} /> },
    ...
    <div className="help-section">
      <div className="mb-4">
        ...
        <p className="text-terminal-muted mb-4">
          Navigate through GitNaut using these terminal commands:
        </p>
      </div>
      ...
      <div className="mt-6 p-4 bg-terminal-hover rounded border-l-4 border-terminal-accent">
        ...
        <ul className="text-terminal-muted space-y-1 text-sm">
          ...
          <li>• Start with <span className="text-terminal-success">gitnaut help</span> for analytics commands</li>
