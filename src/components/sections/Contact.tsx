...
export const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send(
        'service_hx0i52b', // Service ID
        'template_p5aa2yw', // Template ID
        {
          name: formData.name,
        ...
        <div className="contact-info space-y-6">
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3 p-3 bg-terminal-hover rounded border border-terminal-border">
              ...
              <div>
                ...
                <div className="text-terminal-muted text-sm">India</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <a 
                href="https://github.com/PrasannaMishra001" 
                target="_blank" 
              ...
              >
                ...
                <span className="text-terminal-text">github.com/PrasannaMishra001</span>
              </a>
              <a 
                href="https://leetcode.com/u/Prasanna_Mishra/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center space-x-3 p-2 hover:bg-terminal-hover rounded transition-colors"
              >
                <Linkedin size={18} className="text-terminal-accent" />
                <span className="text-terminal-text">leetcode.com/u/Prasanna_Mishra</span>
              </a>
              <a 
                href="https://codeforces.com/profile/prasanna_mishra" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center space-x-3 p-2 hover:bg-terminal-hover rounded transition-colors"
              >
                <Linkedin size={18} className="text-terminal-accent" />
                <span className="text-terminal-text">codeforces.com/profile/prasanna_mishra</span>
              </a>
              <a 
                href="https://www.kaggle.com/prasannamishra" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center space-x-3 p-2 hover:bg-terminal-hover rounded transition-colors"
              >
                <Linkedin size={18} className="text-terminal-accent" />
                <span className="text-terminal-text">kaggle.com/prasannamishra</span>
              </a>
              <a 
                href="https://medium.com/@mishra.prasanna838" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center space-x-3 p-2 hover:bg-terminal-hover rounded transition-colors"
              >
                <Linkedin size={18} className="text-terminal-accent" />
                <span className="text-terminal-text">medium.com/@mishra.prasanna838</span>
              </a>
              <a 
                href="https://x.com/mishra_discover" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center space-x-3 p-2 hover:bg-terminal-hover rounded transition-colors"
              >
                <Linkedin size={18} className="text-terminal-accent" />
                <span className="text-terminal-text">x.com/mishra_discover</span>
              </a>
            </div>
          </div>
        </div>
          ...
          <div className="terminal-window bg-terminal-hover border border-terminal-border rounded-lg overflow-hidden">
            <div className="terminal-header bg-terminal-header p-3 border-b border-terminal-border">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-terminal-muted text-sm">user@gitnaut:~/contact$</span>
              </div>
            </div>
