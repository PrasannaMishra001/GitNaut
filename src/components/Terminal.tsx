...
export const Terminal: React.FC<TerminalProps> = ({ onCommand, output, isProcessing }) => {
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    ...
    if (e.key === 'ArrowUp') {
      ...
      const commands = [
        ...
        'history', 'theme', 'man', 'clear', 'logout', 'gitnaut'
      ];
  ...
  return (
    <div className="terminal-container terminal-glass h-full flex flex-col bg-terminal text-terminal-text font-mono">
      {/* Terminal Header */}
      ...
      <form onSubmit={handleSubmit} className="terminal-input p-4 border-t border-terminal-border"> 
        <div className="flex items-center space-x-2">
          <span className="text-terminal-accent flex-shrink-0">gitnaut@terminal:~$</span>
